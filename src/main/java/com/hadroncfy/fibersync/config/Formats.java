...
public class Formats {
    ...
    public Text confirmationHint = new LiteralText("[Fibersync] 使用")
        .append(new LiteralText("/fs confirm $1").setStyle(Style.EMPTY.withColor(Formatting.GOLD)))
    ...
    public Text backupComplete = new LiteralText("[Fibersync] $1: ")
        .append(new LiteralText("$2").setStyle(Style.EMPTY.withColor(Formatting.GOLD)))
        .append(new LiteralText("已备份完成").setStyle(Style.EMPTY.withColor(Formatting.RESET)));
    ...
    public Text backupListTitle = new LiteralText("存档列表：").setStyle(Style.EMPTY.withColor(Formatting.BLUE));
    public Text mirrorListTitle = new LiteralText("镜像存档列表：").setStyle(Style.EMPTY.withColor(Formatting.BLUE));
    public Text backupListItem = empty().append(new LiteralText("-[$1]").setStyle(Style.EMPTY.withColor(Formatting.GREEN)
            .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText("点击回档至该存档").setStyle(Style.EMPTY.withColor(Formatting.GRAY).withItalic(true))))
            .withClickEvent(new ClickEvent(Action.RUN_COMMAND, "/fs back $1"))))
        .append(new LiteralText(" 时间：").setStyle(Style.EMPTY.withColor(Formatting.WHITE)))
        .append(new LiteralText("$3").setStyle(Style.EMPTY.withColor(Formatting.GREEN)))
        .append(new LiteralText(" 描述：").setStyle(Style.EMPTY.withColor(Formatting.WHITE)))
        .append(new LiteralText("$2").setStyle(Style.EMPTY.withColor(Formatting.GREEN)));
    public Text lockedBackupListItem = empty().append(new LiteralText("-[$1]").setStyle(Style.EMPTY.withColor(Formatting.RED)
            .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText("（此存档已锁定）点击回档至该存档").setStyle(Style.EMPTY.withColor(Formatting.GRAY).withItalic(true))))
            .withClickEvent(new ClickEvent(Action.RUN_COMMAND, "/fs back $1"))))
        .append(new LiteralText(" 时间：").setStyle(Style.EMPTY.withColor(Formatting.WHITE)))
        .append(new LiteralText("$3").setStyle(Style.EMPTY.withColor(Formatting.GREEN)))
        .append(new LiteralText(" 描述：").setStyle(Style.EMPTY.withColor(Formatting.WHITE)))
        .append(new LiteralText("$2").setStyle(Style.EMPTY.withColor(Formatting.GREEN)));
    public Text backupListFooter = empty().append(new LiteralText("总大小：").setStyle(Style.EMPTY.withColor(Formatting.BLUE)))
        .append(new LiteralText("$1M").setStyle(Style.EMPTY.withColor(Formatting.GOLD)));
    ...
    public Text countDownTitle = empty().append(new LiteralText("准备回档：").setStyle(Style.EMPTY.withColor(Formatting.GREEN)))
        .append(new LiteralText("$1").setStyle(Style.EMPTY.withBold(true)));
    ...
    public Text syncCountDownTitle = empty().append(new LiteralText("准备同步：").setStyle(Style.EMPTY.withColor(Formatting.GREEN)))
        .append(new LiteralText("$1").setStyle(Style.EMPTY.withBold(true)));
}